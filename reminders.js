...
var grammar = {
    ...
    {"name": "reminderspec$subexpression$2$subexpression$1", "symbols": [/[tT]/, /[hH]/, /[aA]/, /[tT]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "reminderspec$subexpression$2", "symbols": ["reminderspec$subexpression$2$subexpression$1"]},
    {"name": "reminderspec$subexpression$2$subexpression$2", "symbols": [/[tT]/, /[oO]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "reminderspec$subexpression$2", "symbols": ["reminderspec$subexpression$2$subexpression$2"]},
    ...
    {"name": "reminderspec$subexpression$4$subexpression$1", "symbols": [/[tT]/, /[hH]/, /[aA]/, /[tT]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "reminderspec$subexpression$4", "symbols": ["reminderspec$subexpression$4$subexpression$1"]},
    {"name": "reminderspec$subexpression$4$subexpression$2", "symbols": [/[tT]/, /[oO]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "reminderspec$subexpression$4", "symbols": ["reminderspec$subexpression$4$subexpression$2"]},
    ...
    {"name": "reminderspec$subexpression$6$subexpression$1", "symbols": [/[tT]/, /[hH]/, /[aA]/, /[tT]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "reminderspec$subexpression$6", "symbols": ["reminderspec$subexpression$6$subexpression$1"]},
    {"name": "reminderspec$subexpression$6$subexpression$2", "symbols": [/[tT]/, /[oO]/], "postprocess": function (d) {return d.join(""); }},
    {"name": "reminderspec$subexpression$6", "symbols": ["reminderspec$subexpression$6$subexpression$2"]},
